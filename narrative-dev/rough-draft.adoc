...
* xrefstyle / proper ref catalog
 ** reference signifier terminology
* advanced include tag filtering
* translations of all built-in attributes in 28 languages available from the repository
...
What I'm most excited to cover in this talk, and the most noteworthy, and the most important driver of what's to come, is a new project I've been working on named Antora.
